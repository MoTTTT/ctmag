...
public class GraphPrintFrame_AboutBox extends JDialog implements ActionListener
{
        ...
        String product = "Graphics Printing";
        String version = "1.0";
        String copyright = "Copyright (c) M.J.Colley";
        String comments = "graphics printing code tests";
        public GraphPrintFrame_AboutBox(Frame parent)
        {
                super(parent);
