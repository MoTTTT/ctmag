...
public class MagCurveTest implements java.io.Serializable
{
	...
	private static final long serialVersionUID = 2483499938110285905L;
    public MagCurveTest()
    {
...
//****************************************************************
    ...
    public void setVoltageRatioThreshold(int i)	{ voltage_ratio_threshold= i; }
    public int getVoltageRatioThreshold() { return voltage_ratio_threshold; }
    public void setCurrentRatioThreshold(int i)	{ current_ratio_threshold= i; }
    public int getCurrentRatioThreshold() { return current_ratio_threshold; }
    // Methods to get General Settings values.
    public String getTestname() { return testname; }
    public String getTestername() { return testername; }
    public String getSupplyauthority() { return supplyauthority; }
    public String getSubstation() { return substation; }
    public String getFeeder() { return feeder; }
    // Methods to get CT Settings values.
    public String getCTMake() { return ctmake; }
    public String getCTType() { return cttype; }
    public String getCTClassification() { return ctclassification; }
    public String getCTApplication() { return ctapplication; }
    public String getRednumber() { return rednumber; }
    public String getWhitenumber() { return whitenumber; }
    public String getBluenumber() { return bluenumber; }
    public int getTruePrimCTRatio() { return trueprimctratio; }
    public int getTrueSeconCTRatio() { return trueseconctratio; }
    public String getCTVarating() { return ctvarating; }
    // Methods to get VT Settings values.
    public String getVTMake() { return vtmake; }
    public String getVTType() { return vttype; }
    public String getVTClassification() { return vtclassification; }
    public String getVTPhase() { return vtphase; }
    public String getVTDescription() { return vtdescription; }
    public String getVTSerialno() { return vtserialno; }
    public String getVTIl() { return vtil; }
    public int getTruePrimVTRatio() { return trueprimvtratio; }
    public int getTrueSeconVTRatio() { return trueseconvtratio; }
    public String getVTVarating() { return vtvarating; }
    // Methods to set General Settings.
    public void setTestname(String s) { testname = s; }
    public void setTestername(String s) { testername = s; }
    public void setSupplyauthority(String s) { supplyauthority = s; }
    public void setSubstation(String s) { substation = s; }
    public void setFeeder(String s) { feeder = s; }
    // Methods to set CT Settings.
    public void setCTMake(String s) { ctmake = s; }
    public void setCTType(String s) { cttype = s; }
    public void setCTClassification(String s) { ctclassification = s; }
    public void setCTApplication(String s) { ctapplication = s; }
    public void setRednumber(String s) { rednumber = s; }
    public void setWhitenumber(String s) { whitenumber = s; }
    public void setBluenumber(String s) { bluenumber = s; }
    public void setTruePrimCTRatio(int i) { trueprimctratio = i; }
    public void setTrueSeconCTRatio(int i) { trueseconctratio = i; }
    public void setCTVarating(String s) { ctvarating = s; }
    // Methods to set VT Settings.
    public void setVTMake(String s) { vtmake = s; }
    public void setVTType(String s) { vttype = s; }
    public void setVTClassification(String s) { vtclassification = s; }
    public void setVTPhase(String s) { vtphase = s; }
    public void setVTDescription(String s) { vtdescription = s; }
    public void setVTSerialno(String s) { vtserialno = s; }
    public void setVTIl(String s) { vtil = s; }
    public void setTruePrimVTRatio(int i) { trueprimvtratio = i; }
    public void setTrueSeconVTRatio(int i) { trueseconvtratio = i; }
    public void setVTVarating(String s) { vtvarating = s; }
}
