...
class OptionsAcceptButtonHandler extends java.lang.Object implements java.awt.event.ActionListener  
{
    ...
    public OptionsAcceptButtonHandler(OptionsDialog o, Ctmag f)
    {
        optionsdialog = o;
        ctmag = f;    
    } 
    ...
    public void getTextfields()
    {
     ...
     public void getRadioButtonSelection()
     {
     ...
     protected void getDrawingOptions()
     {
        int draw_area;
...
//     protected void setCsCurrentTextfield(int current)
  //   {
    //    cscurrenttextfield.getText("" + current);
     //}
}