import java.awt.*;
import java.beans.*;
class GeneralReportSettings extends java.awt.Panel 
{
	public GeneralReportSettings()
	{
		super();
		//{{INIT_CONTROLS
		...
		generalsettingspanel.setBackground(new Color(16777215));
		add(generalsettingspanel);
		testnamelabel = new java.awt.Label("Test Name");
		...
		testnametextfield.setFont(new Font("Dialog", Font.PLAIN, 12));
		...
		testertextfield.setEditable(false);
		testertextfield.setBounds(215,54,215,54);
		testertextfield.setFont(new Font("Dialog", Font.PLAIN, 12));
		...
		supplyauthoritytextfield.setEditable(false);
		supplyauthoritytextfield.setBounds(215,108,215,54);
		supplyauthoritytextfield.setFont(new Font("Dialog", Font.PLAIN, 12));
		...
		substationtextfield.setEditable(false);
		substationtextfield.setBounds(215,162,215,54);
		substationtextfield.setFont(new Font("Dialog", Font.PLAIN, 12));
		...
		feedertextfield.setEditable(false);
		feedertextfield.setBounds(215,216,215,54);
		feedertextfield.setFont(new Font("Dialog", Font.PLAIN, 12));
