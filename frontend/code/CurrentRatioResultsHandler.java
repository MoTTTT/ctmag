...
class CurrentRatioResultsHandler extends java.lang.Object  
{
    ...
    {
        trueratio[phase] = trueprimaryctwindings/truesecondaryctwindings;
        measuredratio[phase] = measuredprimaryctwindings/measuredsecondaryctwindings;
    }
...
//        System.out.println("Secondary current ["+phase + "] = " + amp_secon);
   ...
   public void convertMeasuredCTRatios()
   {
        try{
